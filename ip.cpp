...
unsigned int calc_value(String val,const char *delim,String **fields,
                        size_t counter_fields,bool *succ){
...
bool Ip::set_value(String val){
    ...
    unsigned int ip= calc_value(fields[0],sub_delim,&sub_fields,counter_sub_fields,&succ);
...
bool Ip::match_value(String val) const{
    ...
    unsigned int ip_val = calc_value(val,delim,&fields,counter_fields,&succ);
    if (succ==false){
